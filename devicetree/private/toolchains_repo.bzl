...
# By default all these toolchains are registered by the devicetree_register_toolchains macro
...
toolchain(
    ...
    toolchain = "@{user_repository_name}_{platform}//:devicetree_toolchain",
